...
export default function Advantages() {
  ...
  return (
    <section className="relative flex w-full w-full flex justify-center py-20 pb-[132px] bg-[url('/team.webp')] bg-[url('/home-banner-background.webp')] bg-cover after:content-[' '] after:absolute after:top-0 after:left-0 after:bg-blue-800/90 after:w-full after:h-full">
